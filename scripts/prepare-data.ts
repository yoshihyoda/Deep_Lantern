...
const sources:SourceRef[]=[{id:'gebco',provider:'GEBCO',dataset:'GEBCO_2026 Grid + TID',retrievedAt:g.retrievals[0].retrieved_at_utc,attribution:g.attribution,sourceUrl:(await json('gebco/tid_codes.json')).source_url,status:'snapshot',license:g.license,notes:g.notes,metadataUrl:'/data/snapshot/gebco/metadata.json'},{id:'noaa',provider:'NOAA Ocean Exploration',dataset:'EX1702 · Deep Discoverer',retrievedAt:meta.created_at_utc,attribution:n.attribution,sourceUrl:n.discovery_url,status:'snapshot',license:n.license,notes:['DIVE01 did not reach bottom.','Paths are not verified bottom-phase-only tracks.','DIVE13 listed date conflicts with expedition overview.'],metadataUrl:'/data/snapshot/noaa/metadata.json'},{id:'obis',provider:'OBIS · IOC-UNESCO',dataset:'American Samoa occurrence coverage',retrievedAt:meta.created_at_utc,attribution:o.attribution,sourceUrl:o.policy_url,status:'snapshot',license:o.license,notes:o.interpretation,metadataUrl:'/data/snapshot/obis/metadata.json'}];
